...
<ul id="myTab" class="nav nav-tabs">
    <li class="active">
        ...
        <li>
        <a href="<?php echo site_url('Default_controller/addNewsList') ?>">添加新闻</a>
    </li>
</ul>
<table class="table table-striped table-bordered table-hover table-condensed">
    <tr>
   ...
   <?php if($row){
    ...
    ?>
        <tr>
            ...
            <td>
                <img src="<?php echo base_url().$v['thumb'] ?>" height="50" />
            </td>
             <td>
            ...
            <td>
                ...
                <a href="<?php echo site_url('Default_controller/editNews/?news_id='.$v['news_id']); ?>">编辑</a> |
